...
# cam = stage.GetPrimAtPath("/World/OmniGlamCam")

# async def test():
#     for i, preset in enumerate(close_up_presets * 3):
#         rep.functional.modify.pose(
#             cam,
#             position_value=preset[0],
#             look_at_value=preset[1]
#         )
#         await rep.orchestrator.step_async(rt_subframes=4)
#         print(f"Frame {i+1} — cam pos {preset[0]} look_at {preset[1]}")
